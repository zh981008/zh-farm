...
class Automator:
    def __init__(self, auto_task=False, auto_policy=True,
        ...
        """
        self.d = u2.connect('127.0.0.1:62025')
    ...
    def login(self,ac,pwd):
        ...
        self.d(resourceId="com.bilibili.priconne:id/bsgamesdk_edit_username_login").clear_text()
        self.d(resourceId="com.bilibili.priconne:id/bsgamesdk_edit_username_login").send_keys(str(ac))
        self.d(resourceId="com.bilibili.priconne:id/bsgamesdk_edit_password_login").click()
        self.d(resourceId="com.bilibili.priconne:id/bsgamesdk_edit_password_login").clear_text()
        self.d(resourceId="com.bilibili.priconne:id/bsgamesdk_edit_password_login").send_keys(str(pwd))
